...
class Receita:
    def __init__(self,idR, id_medicamento, id_profissional, id_cliente, periodo, dosagem, mais, validade):
        self.set_id(idR)
    ...
    def get_mais (self): return self.__mais
    ...
    def set_mais(self, mais): self.__mais = mais #ex. Preservar em ambiente ventilado
    def set_validade(self, validade):
        if validade < datetime.timedelta(2025, 1, 1): raise ValueError("Data inválida")
        self.__validade = validade

    def to_df(self): pass
    def to_json(self): return {"id": self.__id, "id-medicamento": self.__id_medicamento, "id-profissional": self.__id_profissional, 
                               "id-cliente": self.__id_cliente, "periodo": self.__periodo, "dosagem": self.__dosagem, "mais": self.__mais, 
