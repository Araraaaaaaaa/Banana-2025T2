...
class Cliente:
    ...
    def set_nome(self, nome): 
        if nome == "": raise ValueError("Nome do cliente inválido")
        self.__nome = nome
    def set_email(self, email): 
        if email == "": raise ValueError("Email do cliente inválido")
        self.__email = email
    def set_fone(self, fone): self.__fone = fone
    def set_senha(self, senha): 
        if senha == "": raise ValueError("Senha do cliente inválida")
        self.__senha = senha
